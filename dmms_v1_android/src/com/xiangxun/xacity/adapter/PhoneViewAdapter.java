...
public class PhoneViewAdapter extends PagerAdapter {
	...
	public PhoneViewAdapter(Context context, List<AttBean> pictures) {
		super();
	...
	public View instantiateItem(final ViewGroup container, int position) {
		...
		DcHttpClient.getInstance().requestImage(photoView, mPictures.get(position).mediaPath.equals("null") ? "" : Api.urlImage + mPictures.get(position).mediaPath, R.drawable.view_pager_default, new ResponseImageListener() {
			@Override
