...
/**
 * @package: com.xiangxun.xacity.adapter
 * @ClassName: ProjectSuperviseAdapter.java
 * @Description: 
 * @author: HanGJ
 * @date: 2016-2-26 下午2:31:31
 */
public class ProjectSuperviseAdapter extends BaseAdapter {
	private int childAt;
	...
	public ProjectSuperviseAdapter(Context context, int childAt, XListView mListView) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (childAt == 1) {// 供应商监管
			...
			holder.supplier_title.setText(manageBean.name);
			holder.supplier_contact.setText("项目编号: " + manageBean.code);
			holder.supplier_product.setText("施工地点: " + manageBean.place);
			holder.appraise_man.setText(manageBean.statusHtml);
			holder.appraise_date.setText("启动时间: " + manageBean.starttimeStr);
		}
		return convertView;
	}
