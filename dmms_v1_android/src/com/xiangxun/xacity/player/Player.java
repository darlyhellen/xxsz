...
public abstract class Player implements IPlayer, fCBDecode {
	...
	public int stop() {
		...
		if (playRet == 0 || closeRet == 0) {
			// Log.d("Define.TAG_PC" + this.toString(),
			// "PLAYStop OR  PLAYCloseStream NG");
			return Err.NG;
		}
		// Log.d("Define.TAG_PC" + this.toString(),
		// "PLAYStop and  PLAYCloseStream OK");
		return Err.OK;
	}
	...
	public int snapShot(String filePath) {
		...
		// Log.d(this.toString(), "snapShot:" + ((ret == Err.OK) ? "OK" :
		// "NG"));
		return ret;
	}
	...
	public int startRecord(String filePath) {
		...
		// Log.d(this.toString(), "startRecord:" + ((ret == Err.OK) ? "OK" :
		// "NG"));
		return ret;
	}
	...
	public int stopRecord() {
		...
		// Log.d(this.toString(), "stopRecord:" + ((ret == Err.OK) ? "OK" :
		// "NG"));
		return ret;
	}
	 ...
	 * com.company.PlaySDK.IPlaySDKCallBack.FRAME_DECODE_INFO decodeInfo,
	 * com.company.PlaySDK.IPlaySDKCallBack.FRAME_INFO_EX frameInfo, long arg3)
	 * { Time time = new Time(frameInfo.nYear, frameInfo.nMonth, frameInfo.nDay,
	 * frameInfo.nHour, frameInfo.nMinute, frameInfo.nSecond);
	 * if(this.playerListener != null) { if((this.curTime == null) ||
	 * !(this.curTime.equals(time))) { this.playerListener.onPlayerTime(this,
	 * time); this.curTime = time; } } }
	 */
