 ...
 * @ClassName: ClearEditText.java
 * @Description: 输入文字带清除按钮
 * @author: HanGJ
 * @date: 2015-11-16 上午9:40:29
 */
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			mClearDrawable = getResources().getDrawable(R.drawable.more_clear);
		}
	...
	public void setClearX(int dra) {
		mClearDrawable = getResources().getDrawable(dra);
		mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());
	}
