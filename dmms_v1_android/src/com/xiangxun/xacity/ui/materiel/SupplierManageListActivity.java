...
import com.xiangxun.xacity.adapter.SupplierManageAdapter;
...
import com.xiangxun.xacity.ui.materiel.detail.SupplierManageDetailActivity;
import com.xiangxun.xacity.ui.materiel.detail.SupplierManageTodoDetailActivity;
...
/**
 * @package: com.xiangxun.xacity.ui.materiel
 * @ClassName: SupplierManageListActivity.java
 * @Description: 物料管理-->供应商管理页面
 * @author: HanGJ
 * @date: 2016-1-25 下午4:34:53
 */
public class SupplierManageListActivity extends BaseActivity implements OnClickListener, IXListViewListener, OnItemClickListener {
	...
	private String menuid3 = "1501151544012684bc32cd16640d7619";
	...
	private SupplierManageAdapter adapterTodo;
	...
	public void initData() {
		...
		getMenuId();
		adapter = new SupplierManageAdapter(this, childAt, mXListView);
		adapterTodo = new SupplierManageAdapter(this, childAt, mXListView_Todo);
		RequestListHistory();
	}
	...
	private void RequestListHistory() {
		...
		if (childAt == 0) {// 采购单管理网络请求
			DcNetWorkUtils.getSupplierPurchaseManageList(this, handler, 1, account, password, currentPage + "", PageSize + "", menuid1, projectName, type, supplier, month);
		} else if (childAt == 1) {// 发货单管理网络请求
			DcNetWorkUtils.getSupplierDeliverManageList(this, handler, 1, account, password, currentPage + "", PageSize + "", menuid2, projectName, type, supplier, month);
		} else if (childAt == 2) {// 库存管理网络请求
			DcNetWorkUtils.getSupplierStoreManageList(this, handler, 1, account, password, currentPage + "", PageSize + "", menuid3, name, type, supplier);
		} else if (childAt == 3) {// 入库管理网络请求
			DcNetWorkUtils.getSupplierInStoreManageList(this, handler, 1, account, password, currentPage + "", PageSize + "", menuid4, name, type, supplier);
		} else if (childAt == 4) {// 出库管理网络请求
			DcNetWorkUtils.getSupplierOutStoreManageList(this, handler, 1, account, password, currentPage + "", PageSize + "", menuid5, name, type, supplier);
		}
	}
	...
	private void RequestListTodo() {
		...
		if (childAt == 0) {// 采购单管理网络请求
			DcNetWorkUtils.getSupplierPurchaseManageList(this, handler, 0, account, password, currentPage_todo + "", PageSize + "", menuid1, projectName, type, supplier, month);
		} else if (childAt == 1) {// 发货单管理网络请求
			DcNetWorkUtils.getSupplierDeliverManageList(this, handler, 0, account, password, currentPage_todo + "", PageSize + "", menuid2, projectName, type, supplier, month);
		} else if (childAt == 2) {// 库存管理网络请求
			DcNetWorkUtils.getSupplierStoreManageList(this, handler, 0, account, password, currentPage_todo + "", PageSize + "", menuid3, name, type, supplier);
		} else if (childAt == 3) {// 入库管理网络请求
			DcNetWorkUtils.getSupplierInStoreManageList(this, handler, 0, account, password, currentPage_todo + "", PageSize + "", menuid4, name, type, supplier);
		} else if (childAt == 4) {// 出库管理网络请求
			DcNetWorkUtils.getSupplierOutStoreManageList(this, handler, 0, account, password, currentPage_todo + "", PageSize + "", menuid5, name, type, supplier);
		}
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.xw_share:
			Intent intent = new Intent(this, SupplierManageSearchActivity.class);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		case R.id.xlistview_history:
			...
			intent = new Intent(this, SupplierManageDetailActivity.class);
			break;
		case R.id.xlistview_todo:
			bean = adapterTodo.getItem(position - 1);
			intent = new Intent(this, SupplierManageTodoDetailActivity.class);
			break;
		}
				...
				if (childrenRoot != null && "供应管理".equals(childrenRoot.getName())) {
					...
					if (childrens != null && childrens.size() > 0) {
						for (int j = 0; j < childrens.size(); j++) {
							...
							if (children2 != null && "采购单管理".equals(children2.getName())) {
								menuid1 = children2.getId();
							} else if (children2 != null && "发货单管理".equals(children2.getName())) {
								menuid2 = children2.getId();
							} else if (children2 != null && "库存管理".equals(children2.getName())) {
								menuid3 = children2.getId();
							} else if (children2 != null && "入库管理".equals(children2.getName())) {
								menuid4 = children2.getId();
							} else if (children2 != null && "出库管理".equals(children2.getName())) {
								menuid5 = children2.getId();
							}
						}
					}
				}
